...
def main():
    try:
        ...
        # FIXED: Explicitly resolve root directory paths relative to the script file
        script_dir = Path(os.path.dirname(os.path.abspath(__file__)))
        ROOT_DIR = script_dir.parent.parent  # Up two levels from src/features to repository root

        DATA_PATH_TRAIN = ROOT_DIR / "data" / "raw" / "train.csv"
        DATA_PATH_TEST = ROOT_DIR / "data" / "raw" / "test.csv"
        ...
        # FIXED: Pass absolute directory to prevent relative environment directory generation shifts
