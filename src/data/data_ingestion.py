...
def main():
    try:
        # Get the root directory relative to this script's location
        script_dir = Path(os.path.dirname(os.path.abspath(__file__)))
        ROOT_DIR = script_dir.parent.parent  # Up two levels from src/data to root
        ...
        # FIXED: Load data using absolute path anchored from the project root directory
        DATA_PATH = ROOT_DIR / "dataset" / "sentiments.csv"

        # Use the built-in load_data wrapper to catch parsing errors cleanly
